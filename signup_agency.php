...
<div class="signup">
        <form action="signuppr_agency.php" method="post">
            <h1>Looks like you're new agent here!</h1>
            ...
            <button class="login-button"><a href="login_agency.php">Already an agent, login here!!</a></button>
